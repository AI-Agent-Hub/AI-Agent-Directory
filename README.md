# AI Agent Directory Awesome list of AI Agents in Various Industries and Applications

For quick navigation, you can visit [AI Agent Marketplace](http://www.deepnlp.org/store/ai-agent) and [AI Agent Search Engine](http://www.deepnlp.org/search/agent) to find and list your AI Agent.
